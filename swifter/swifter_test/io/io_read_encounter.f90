...
!    File      : none
!
!  Invocation  : istat = io_read_encounter(t, id1, id2, mass1, mass2, radius1, radius2, xh1, xh2, vh1, vh2, encounter_file, out_type)
!
...
!
!**********************************************************************************************************************************
FUNCTION io_read_encounter(t, id1, id2, mass1, mass2, radius1, radius2, xh1, xh2, vh1, vh2, encounter_file, out_type)
...
! Executable code
     ...
     IF (lxdr) THEN
          ...
          IF (ierr /= 0) THEN
               ...
               RETURN
          END IF
          ierr = io_read_line(iu, id1, xh1(1), xh1(2), xh1(3), vh1(1), vh1(2), vh1(3), XDR8_TYPE, MASS = mass1, RADIUS = radius1)
          io_read_encounter = ierr
          IF (ierr /= 0) THEN
               ierr = ixdrclose(iu)
               RETURN
          END IF
          ierr = io_read_line(iu, id2, xh2(1), xh2(2), xh2(3), vh2(1), vh2(2), vh2(3), XDR8_TYPE, MASS = mass2, RADIUS = radius2)
          io_read_encounter = ierr
          IF (ierr /= 0) THEN
               ierr = ixdrclose(iu)
               RETURN
     ...
     ELSE
          ...
          IF (ierr /= 0) THEN
               ...
               RETURN
          END IF
          ierr = io_read_line(iu, id1, xh1(1), xh1(2), xh1(3), vh1(1), vh1(2), vh1(3), REAL8_TYPE, MASS = mass1, RADIUS = radius1)
          io_read_encounter = ierr
          IF (ierr /= 0) THEN
               CLOSE(UNIT = iu, IOSTAT = ierr)
               RETURN
          END IF
          ierr = io_read_line(iu, id2, xh2(1), xh2(2), xh2(3), vh2(1), vh2(2), vh2(3), REAL8_TYPE, MASS = mass2, RADIUS = radius2)
          io_read_encounter = ierr
          IF (ierr /= 0) THEN
               CLOSE(UNIT = iu, IOSTAT = ierr)
               RETURN
