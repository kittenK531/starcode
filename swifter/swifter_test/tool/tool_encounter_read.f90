...
! Internals
     ...
     REAL(DP)                  :: t,mass1,mass2,radius1,radius2
...
! Executable code
 ...
 100 FORMAT(A)
     ...
     i=0
     DO
          ierr=io_read_encounter(t,id1,id2,mass1,mass2,radius1,radius2,xh1,xh2,vh1,vh2,encounter_file,out_type)
          IF (ierr /= 0) EXIT
          i=i+1
          WRITE(*,*)"Encounter #",i
          WRITE(*,*)"Time = ",t
          WRITE(*,*)" Body1: ",id1,mass1,radius1,xh1,vh1
          WRITE(*,*)" Body2: ",id2,mass2,radius2,xh2,vh2
     END DO
